...
export const DESCRIPCION_ROL = {
  ...
  ADMINISTRADOR: 'Administra los espacios de la facultad, los usuarios y los reportes.',
  LABORATORISTA: 'Carga los horarios de clases y controla la ocupación de las aulas.',
};
