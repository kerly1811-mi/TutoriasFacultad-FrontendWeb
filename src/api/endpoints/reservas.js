...
export const reservasApi = {
  ...
  // datos = { id_esp, fecha: 'YYYY-MM-DD', hor_ini: 'HH:MM', hor_fin: 'HH:MM', motivo }
  // Puede responder 409 si el aula ya está ocupada en esa franja.
  crear: (datos) => api.post('/reservas', datos).then((res) => res.data),

  // PATCH /api/reservas/:id/cancelar (dueño o ADMIN) -> { mensaje, reserva }
  cancelar: (id) => api.patch(`/reservas/${id}/cancelar`).then((res) => res.data),
