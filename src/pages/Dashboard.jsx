...
const DESCRIPCION_SECCION = {
  ...
  '/carreras': 'Carreras de la facultad y sus niveles.',
  '/materias': 'Materias que se dictan en la facultad.',
  '/paralelos': 'Asigna una materia, nivel y docente a un paralelo.',
